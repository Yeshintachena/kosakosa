...
function renderList() {
  ...
  filtered.forEach(item => {
    ...
    card.innerHTML = `
      ...
      <button class="audio-btn" onclick="playAudio('${item.audio}')">🔊</button>
    `;
